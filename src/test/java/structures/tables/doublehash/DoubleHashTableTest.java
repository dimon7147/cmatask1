...
class DoubleHashTableTest {
    ...
    public void delete() {
        ...
        table.put(4, 4);
        table.put(5, 5);
        Assertions.assertTrue(table.remove(1));
        Assertions.assertTrue(table.remove(2));
        Assertions.assertTrue(table.remove(3));
        Assertions.assertTrue(table.remove(4));
        Assertions.assertTrue(table.remove(5));
        for (int i = 1; i < 6; i++) {
    ...
    public void deleteNonExisted() {
        ...
        Assertions.assertFalse(table.remove(2));
        Assertions.assertFalse(table.remove(3));
    }
}